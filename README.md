Step 1: get an API card
GEOAPIFY_API_KEY = "YOUR_GEOAPIFY_API_KEY" and place it here inside the code I have in my file in the repository

Step 1b: choose a free website that can track places with an API Key:
https://www.geoapify.com/

Step 2: Go on notepad or wherever you want to save the code into a file and name it and save it inside a folder
